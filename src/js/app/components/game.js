...
import Enviroment from "./components-3d/enviroment";
...
export default class Game {
  ...
  _initEnvironment() {
    this._environment = new Enviroment(this._camera.threeCamera, this._scene, this._raycasterPlane);
